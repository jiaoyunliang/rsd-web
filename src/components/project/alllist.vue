...
<script>
  ...
  import AddAllProjectDialog from "@/components/project/addallproject";

  export default {
  components: { AddAllProjectDialog },
  props: {
    isView: ""
  },
  data() {
  ...
  methods: {
    ...
    handleShowProject: function(projectInfo) {
      if (projectInfo) {
        ...
        this.$parent.$parent.$parent.$parent.$parent.$parent.showChildBreadcrumb(
