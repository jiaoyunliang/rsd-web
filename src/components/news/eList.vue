          ...
          <el-table-column label="操作" width="340">
            <template slot-scope="scope">
              <el-button
                ...
                type="primary"
                size="mini"
                v-if="scope.row.isTop === 0 && checkButton('001001001002')"
                >置顶</el-button
              >
              <el-button
              ...
              <el-button
                ...
                type="primary"
                size="mini"
                v-if="scope.row.isRed === 0 && checkButton('001001001002')"
                >飘红</el-button
              >
              <el-button
              ...
              <el-button
                ...
                type="danger"
                size="mini"
                v-if="scope.row.isDel === 0 && checkButton('001001001003')"
                >删除</el-button
              >
            </template>
          </el-table-column>
